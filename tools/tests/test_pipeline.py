...
class TestHalleneinpassung:
    ...
    def test_staende_folgen_ihrer_halle(self):
        ...
        for key in verkleinert:
            ...
            plan_stands = {s["id"]: s["polygon"] for s in plan["stands"] if s["hallKey"] == key}
            if not plan_stands:
                continue
